...
class  NaiveBayes:
	...
	def __init__(self):
		...
		"""
			Attributes:
				...
				class_priors: Priass_prior(self)or probabilities of classes 
	...
	def _calc_class_prior(self):
		...
		for outcome in np.unique(self.y_train):
			...
			self.class_priors[outcome] = np.count_nonzero(self.y_train == outcome)/self.train_size #TODO_2    Remove 0 and write your code 
    		### YOUR CODE ENDS HERE ###
	...
	def predict(self, X):
		...
		for query in X:
			...
			result = max(zip(probs_outcome.values(), probs_outcome.keys()))[1] #TODO_3          Remove None and get the Max
